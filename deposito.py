...
# Fungsi untuk menghitung cicilan bulanan dengan bunga sederhana
def hitung_cicilan_bulanan_sederhana(pokok_hutang, jumlah_bulan, bunga_tahunan, bunga_per_hari, hari_terlambat):
...
# Fungsi untuk menghitung cicilan bulanan dengan bunga majemuk
def hitung_cicilan_bulanan_majemuk(pokok_hutang, jumlah_bulan, bunga_tahunan, bunga_per_hari, hari_terlambat):
    bunga_per_bulan = (1 + bunga_tahunan / 100) ** (1/12) - 1
    jumlah_akhir = pokok_hutang * (1 + bunga_per_bulan) ** jumlah_bulan
    cicilan_bulanan = jumlah_akhir / jumlah_bulan
...
jenis_bunga = input("Pilih jenis bunga (sederhana/majemuk): ").lower()
...
if jenis_bunga == 'sederhana':
    cicilan_bulanan, denda = hitung_cicilan_bulanan_sederhana(pokok_hutang, jumlah_bulan, bunga_tahunan, bunga_per_hari, hari_terlambat)
elif jenis_bunga == 'majemuk':
    cicilan_bulanan, denda = hitung_cicilan_bulanan_majemuk(pokok_hutang, jumlah_bulan, bunga_tahunan, bunga_per_hari, hari_terlambat)
else:
    print("Jenis bunga tidak valid. Pilih antara 'sederhana' atau 'majemuk'.")
    exit()
